...
def plan(warehouse, dropzone, todo):
    ...
    for i in range(len(todo)):
        ...
        for m in range(len(warehouse)):
            for n in range(len(warehouse[0])):
                if warehouse[m][n]==box:
                    goal[0]=m
                    goal[1]=n
                ...
                for y in range(len(warehouse[0])):
                    ...
                    if goal[0] == x and goal[1] == y:
                        ...
                        for a in range(len(delta)):
                            ...
                            if x2 >= 0 and x2 < len(warehouse) and y2 >= 0 and y2 < len(warehouse[0]) and (warehouse[x2][y2] == 0 or warehouse[x2][y2]=='x' or warehouse[x2][y2] == warehouse[goal[0]][goal[1]]):
                                if (a*2)<len(delta):
                                    v2 = value[x2][y2] + cost_step
                                else:
                                    v2 = value[x2][y2] + cost_diag_step
        ...
        cost += 2.0*value[dropzone[0]][dropzone[1]]
